      ...
      <section className="bg-white py-20 dark:bg-gray-950">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6 text-slate-600 dark:text-gray-300">
            <p>
              LEO Education chỉ thu thập thông tin cần thiết để tư vấn lộ trình học online, bao gồm họ tên,
            ...
            <p>
              ...
              và cải thiện chất lượng dịch vụ. LEO Education không bán hoặc chia sẻ dữ liệu cá nhân cho bên thứ ba
