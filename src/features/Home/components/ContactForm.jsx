        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="inline-block mb-4">
              <span className="px-4 py-2 bg-gradient-to-r from-teal-50 to-gold-50 dark:from-teal-900/30 dark:to-gold-900/30 border border-teal-200 dark:border-teal-700 text-teal-700 dark:text-teal-300 rounded-full text-sm font-semibold flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            >
              <div className="bg-slate-50 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-slate-100 dark:border-gray-800">
                ...
                <div className="space-y-4">
                  {benefits.map((item, index) => (
                    ...
                    >
                      <span className="text-3xl">{item.icon === Sparkles ? '✨' : item.icon === Clock ? '⏰' : item.icon === GraduationCap ? '🎓' : '🛡️'}</span>
                      <div>
              ...
              {/* Promotion banner */}
              <div className="bg-gradient-to-br from-teal-500 to-navy-600 rounded-2xl p-6 text-white shadow-lg">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input {...register('parentName')} placeholder="Nguyễn Văn A"
                          className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 outline-none bg-white dark:bg-gray-800 text-slate-800 dark:text-white ${errors.parentName ? 'border-red-400 focus:border-red-500' : 'border-slate-200 dark:border-gray-600 focus:border-teal-500'} focus:ring-2 focus:ring-teal-200`}
                        />
                      ...
                      <div>
                        ...
                        <input {...register('childName')} placeholder="Bé Minh"
                          className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 outline-none bg-white dark:bg-gray-800 text-slate-800 dark:text-white ${errors.childName ? 'border-red-400 focus:border-red-500' : 'border-slate-200 dark:border-gray-600 focus:border-teal-500'} focus:ring-2 focus:ring-teal-200`}
                        />
                    ...
                    <div>
                      ...
                      <input {...register('email')} type="email" placeholder="example@email.com"
                        className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 outline-none bg-white dark:bg-gray-800 text-slate-800 dark:text-white ${errors.email ? 'border-red-400 focus:border-red-500' : 'border-slate-200 dark:border-gray-600 focus:border-teal-500'} focus:ring-2 focus:ring-teal-200`}
                      />
                    ...
                    <div>
                      ...
                      <input {...register('phone')} type="tel" placeholder="0123456789"
                        className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 outline-none bg-white dark:bg-gray-800 text-slate-800 dark:text-white ${errors.phone ? 'border-red-400 focus:border-red-500' : 'border-slate-200 dark:border-gray-600 focus:border-teal-500'} focus:ring-2 focus:ring-teal-200`}
                      />
                    ...
                    <div>
                      ...
                      <textarea {...register('message')} rows="4" placeholder={t('contact.messagePlaceholder') || 'Vui lòng cho biết độ tuổi của con và môn học bạn quan tâm...'}
                        className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 resize-none outline-none bg-white dark:bg-gray-800 text-slate-800 dark:text-white ${errors.message ? 'border-red-400 focus:border-red-500' : 'border-slate-200 dark:border-gray-600 focus:border-teal-500'} focus:ring-2 focus:ring-teal-200`}
                      />
